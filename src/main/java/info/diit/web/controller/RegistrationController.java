...
public class RegistrationController {
    ...
    public String showRegistrationForm(WebRequest request, Model model) {
        ...
        System.out.println("==================User Rsgistration Page============");
    ...
    public ModelAndView registerUserAccount(@ModelAttribute("user") @Valid UserDto accountDto, BindingResult result,WebRequest request, Errors errors,HttpSession session) {
